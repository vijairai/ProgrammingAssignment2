## This function is  written in partial t of Coursera Data Science: R Programming  ## Week 3 Assignment; week beginning July 23 
 ## This function creates a special "matrix" object that can cache its inverse 
makeCacheMatrix <- function(x = matrix()) { 
        ## define the argument with default mode of "matrix"       
        inv <- NULL                             
        ## initial value inv as NULL; will hold value of matrix inverse       
